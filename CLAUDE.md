...
- At module and function boundaries, return immutable data rather than accepting mutable objects to modify — reduces dependency
  on caller's types and keeps modules decoupled 
